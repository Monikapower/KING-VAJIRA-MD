...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '94761544363';
...
global.email = 'kaveenchamodya167@gmail.com' ;
...
global.website = 'https://github.com/vajirabot1/KING-VAJIRA-MD' ; //wa.me/+94761544363
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/fb7993e24f7ecdaecbed5.jpg' ;
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;BowelsSpanked
",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'Dark Alfa',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `It'x Alfa`,
